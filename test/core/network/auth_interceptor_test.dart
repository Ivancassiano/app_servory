...
void main() {
  ...
  test(
    '401 dispara refresh e repete a chamada original com o novo token',
    () async {
  ...
  test(
    'duas chamadas concorrentes expirando juntas compartilham um único refresh',
    () async {
      var refreshCalls = 0;
      authDio.httpClientAdapter = _FakeAdapter((options) async {
        refreshCalls++;
