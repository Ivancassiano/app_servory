...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _biometricLogin() async {
    ...
    try {
      ...
      if (mounted) {
        setState(
          () => _errorMessage = 'Não foi possível entrar com a digital.',
        );
      }
    }
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // Login OK: fecha o contexto de autofill para o gerenciador de senhas
      // (cofre) oferecer "salvar" as credenciais associadas ao app.
